...
exports.unique = exports.toObjectMap = exports.toArrayMap = exports.nonNull = exports.BaseEntity = exports.AsyncLock = void 0;
...
function nonNull(array) {
    return array.filter(Boolean).map(function (o) { return o; });
}
