...
exports.unique = exports.toObjectMap = exports.toArrayMap = exports.nonNull = exports.exists = exports.BaseEntity = exports.AsyncLock = void 0;
...
function nonNull(array) {
    return array.filter(exists).map(function (o) { return o; });
}
